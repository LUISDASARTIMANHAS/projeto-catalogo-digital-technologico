/**
 * ============================================================================
 * InovaTech - Loja (Catálogo de Produtos)
 * ----------------------------------------------------------------------------
 ...
 * chamadas assíncronas ao servidor central da InovaTech
 * (https://InovaTech-sg.onrender.com/) sem exigir mudanças na camada de
 * renderização.
 *
 ...
 * substituída por: `return fetch('https://InovaTech-sg.onrender.com/api/produtos').then(r => r.json());`
