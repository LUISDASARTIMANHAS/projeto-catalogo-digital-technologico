/**
 * ============================================================================
 * InovaTech - Camada de Dados da Loja
 * ----------------------------------------------------------------------------
 ...
 * substituídas por chamadas fetch() ao servidor central da InovaTech
 * (https://InovaTech-sg.onrender.com/) sem alterar o restante da aplicação.
 *
...
const PRODUCTS = [
  {
    ...
    warranty: "12 meses InovaTech + suporte remoto",
    condition: "seminovo",
    stock: 4,
    weightKg: 16.5,
